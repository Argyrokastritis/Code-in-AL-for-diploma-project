report 50010 "Admin ec stats and ins report"
{

    DefaultLayout = RDLC;
    RDLCLayout = './Admin ec stats and insurances report.rdl';
    ...
    dataset
    {
        ...
        {
            //Admin's stats columns
            column(Total_Company_earnings_CPT; Total_Company_earnings_CPT)
            {
            }
            column(Total_Expected_earnings_CPT; Total_Expected_earnings_CPT)
            {
            }
            column(Total_Company_Expenses_CPT; Total_Company_Expenses_CPT)
            {
            }
            column(Total_Max_Expected_Company_Expenses_CPT; Total_Max_Expected_Company_Expenses_CPT)
            {
            }
            column(Total_Company_earnings; Total_Company_earnings)
            {
            }
            column(Total_Expected_earnings; Total_Expected_earnings)
            {
            }
            column(Total_Company_Expenses; Total_Company_Expenses)
            {
            }
            column(Total_Max_Expected_Company_Expenses; Total_Max_Expected_Company_Expenses)
            {
            }
            //Info of company
    ...
    var
        ...
        //Admin's statistics variables
        Total_Company_earnings: Integer;
        Total_Expected_earnings: Integer;
        Total_Company_Expenses: Integer;
        Total_Max_Expected_Company_Expenses: Integer;

        //Admin's statistics CPT's
        Total_Company_earnings_CPT: TextConst ENU = 'Total Company earnings', ENG = 'ΣΥΝΟΛΙΚΑ ΕΣΟΔΑ ΕΤΑΙΡΕΙΑΣ';
        Total_Expected_earnings_CPT: TextConst ENU = 'Total expected earnings', ENG = 'ΣΥΝΟΛΙΚΑ ΑΝΑΜΕΝΟΜΕΝΑ ΕΣΟΔΑ ΕΤΑΙΡΕΙΑΣ';
        Total_Company_Expenses_CPT: TextConst ENU = 'Total company expenses', ENG = 'ΣΥΝΟΛΙΚΑ ΕΞΟΔΑ ΕΤΑΙΡΕΙΑΣ';
        Total_Max_Expected_Company_Expenses_CPT: TextConst ENU = 'Total maximum company expenses', ENG = 'ΜΕΓΙΣΤΑ ΣΥΝΟΛΙΚΑ ΕΞΟΔΑ ΕΤΑΙΡΕΙΑΣ';
    ...
    begin
        ...
        if payment.findfirst() then
            repeat
                //amount1 := amount1 + payment.amount;
