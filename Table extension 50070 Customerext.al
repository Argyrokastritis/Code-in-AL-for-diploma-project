tableextension 50070 "Customerext" extends Customer
{
    fields
    {
        ...
        field(50150; "Insured company promotion"; Option)
        {
            ...
            OptionMembers = "Brought less than 2 customers","Brought between 2 and 5 customers","Brought between 5 and 7 customers","Brought between 7 and 10 customers","Brought more than 10 customers";
        }
    }
}